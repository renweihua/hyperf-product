    ...
    <div class="filter-container">
      ...
      >
        <el-option
          key="CategoryId"
          hidden
          :value="listQuery.category_id"
          :label="select_category_name"
        />
        <el-tree
          :data="category"
          :props="defaultProps"
