  ...
  <div class="createPost-container">
    ...
    >
      ...
      <div class="createPost-main-container">
        ...
        <el-form-item
          v-if="postForm.config_type == 2"
          label="配置值（数字）:"
        >
          <el-input
            v-model="config_value_number"
            :rows="1"
            type="number"
            autosize
            placeholder="Please enter the 配置值"
          />
        </el-form-item>

        <el-form-item
          v-else-if="postForm.config_type == 5"
          label="配置值（图片）"
        >
          <pan-thumb
        ...
        <el-form-item
          v-else-if="postForm.config_type == 6"
          label="配置值（富文本）:"
        >
          <markdown-editor
            v-model="config_value_markdown"
            height="400px"
          />
        </el-form-item>
        ...
        <el-form-item label="配置项:">
          <el-input
            v-model="postForm.config_extra"
            :rows="1"
            type="textarea"
            autosize
            placeholder="Please enter the 配置项"
          />
        ...
        <el-form-item label="排序">
          <el-input
            v-model.trim="postForm.config_sort"
            type="number"
            autocomplete="off"
          />
