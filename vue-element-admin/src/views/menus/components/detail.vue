  ...
  >
    ...
    >
      ...
      <el-form-item label="列表页模板">
        <el-select
          v-model="form.menu_listtpl"
          placeholder="请选择列表页模板"
          autocomplete="off"
        >
          <el-option
            key=""
      ...
      <el-form-item label="详情页模板">
        <el-select
          v-model="form.menu_detailtpl"
          placeholder="请选择详情页模板"
          autocomplete="off"
        >
          <el-option
            key=""
      ...
      <el-form-item label="是否首页展示">
        <el-radio-group v-model="form.is_show">
          <el-radio
            :label="1"
            :checked="form.is_show == 1 ? 'checked' : ''"
          >
            展示
          </el-radio>
          <el-radio
            :label="0"
            :checked="form.is_show == 0 ? 'checked' : ''"
          >
            隐藏
          </el-radio>
        </el-radio-group>
