...
class Rsa {
    ...
    {
        return BASE_PATH . '/config/rsa-config';
    }
    ...
    public static function privEncrypt(array $data)
    {
        ...
        return openssl_private_encrypt($data,$encrypted,self::getPrivateKey()) ? base64_encode($encrypted) : false;
    }
    ...
    public static function publicEncrypt(array $data)
    {
        ...
        return openssl_public_encrypt($data,$encrypted, self::getPublicKey()) ? base64_encode($encrypted) : false;
    }
    ...
    public static function privDecrypt($encrypted = '')
    {
        ...
        return json_decode((openssl_private_decrypt(base64_decode($encrypted), $decrypted, self::getPrivateKey())) ? $decrypted : false);
    }
    ...
    public static function publicDecrypt($encrypted = '')
    {
        ...
        return (openssl_public_decrypt(base64_decode($encrypted), $decrypted, self::getPublicKey())) ? $decrypted : false;
    }
